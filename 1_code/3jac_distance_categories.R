...
categories_wikipedia <- read_csv("3_data_api_queries/complete_categories_wikipedia.csv")
...
write_csv(df, "3_data_api_queries/wikicategories_distances_filtered.csv")

humans <- read_csv("4_data_reconciliation/theorystrings_categories_humans.csv")
...
write_csv(humans_jac06, "5_data_enrichment/theorystrings_humans_smalljacdistance.csv")
