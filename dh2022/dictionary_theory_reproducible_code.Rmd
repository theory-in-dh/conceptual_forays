...
abstract: |
  ...
  This page was generated with this file: [Rmd File](https://github.com/eisioriginal/conceptual_forays/blob/main/dh2022/dictionary_theory_reproducible_code.Rmd)
output: 
  html_document:
    theme: readable
    highlight: tango
...
```{r jac_dist_exploration, echo=T, eval=F, warning=F, cache=T, message=F}
#### Data exploration #### 
...
```{r jac_dist_filter, echo=T, eval=T, warning=F, cache=T, message=F}
#### Filter categories #### 
