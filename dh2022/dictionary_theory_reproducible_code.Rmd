...
categories_wikipedia <- read_csv("../data/3_complete_categories_wikipedia.csv")
...
```{r wikidata_search, warning=F, cache=T, message=F}
##### Load function #####
...
##### Fetch data #####
data <- read_csv("../data/4_theory_dictionary_wikidata_extended.csv")
##### Clean column names #####
...
authors <- read.csv(file = "../data/theorystrings_categories_humans.csv")
